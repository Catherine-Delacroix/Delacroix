...
def mod_or_inv():
    def predicate(ctx):
        return role_or_permissions(ctx, ('Moderator', 'Admin', 'Bot Inventory', 'Guardians'),
                                   manage_server=True)
...
def modpredicate(ctx):
    return role_or_permissions(ctx, lambda r: r.name in ('Moderator', 'Admin', 'Guardians'),
                               manage_server=True)


def mod_or_permissions(**perms):
    def predicate(ctx):
        result = role_or_permissions(ctx, ('Moderator', 'Admin', 'Guardians'),
